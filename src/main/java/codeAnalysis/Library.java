 ...
 *
 * Licensed under the Apache codeAnalysis.License, Version 2.0 (the "codeAnalysis.License");
 * you may not use this file except in compliance with the codeAnalysis.License.
 * You may obtain a copy of the codeAnalysis.License at
 *
 *    http://www.apache.org/licenses/LICENSE-2.0
 *
 * Unless required by applicable law or agreed to in writing, software
 * distributed under the codeAnalysis.License is distributed on an "AS IS" BASIS,
 * WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.
 * See the codeAnalysis.License for the specific language governing permissions and
 * limitations under the codeAnalysis.License.
 */

/**
 * An enumeration of common Android libraries with their codeAnalysis.Attribution information.
 */
public enum Library {
